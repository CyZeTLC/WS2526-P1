@echo off
REM Setzen Sie die Umgebungsvariable LOCAL_JAVAFX_SDK_LIB auf den Pfad zu Ihrem JavaFX-SDK/lib-Ordner
set LOCAL_JAVAFX_SDK_LIB="C:\Users\Tom\Documents\javafx-sdk-17.0.17\lib"

REM Pfad zur jpackage.exe (der gesamte Pfad MUSS in Anführungszeichen stehen)
